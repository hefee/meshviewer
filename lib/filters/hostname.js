define(function () {
  ...
  return function () {
    ...
    function run(d) {
      if (d.hostname.toLowerCase().includes(input.value.toLowerCase())) {
        return true;
      }
      if (d.mac.toLowerCase().includes(input.value.toLowerCase())) {
        return true;
      }
      var macs = d.macs;
      if (macs) {
        if (macs.some(function (mac) {
          return mac.toLowerCase().includes(input.value.toLowerCase());
        })) {
          return true;
        }
      }
      ...
      if (addresses) {
        if (addresses.some(function (address) {
          return address.toLowerCase().includes(input.value.toLowerCase());
        })) {
          return true;
        }
      }
